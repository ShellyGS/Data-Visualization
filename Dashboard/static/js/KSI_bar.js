// Function to update the chart based on selected district
...
d3.csv("http://127.0.0.1:8000/Data/KSI_cleaned.csv").then(function (data) {
    // Populate the district dropdown with unique values
    var districtDropdown = d3.select("#district");
    var districtOptions = Array.from(new Set(data.map(function (d) { return d.DISTRICT; })));
